...
<head>
    ...
    <title>LaundryPOS | New Transaction</title>
    ...
    <main class="pos-shell">
        <aside class="sidebar">
            ...
            <nav class="side-nav" aria-label="Main navigation">
                ...
                <a class="nav-link active" href="#orders"><span class="nav-icon">⊕</span> New transaction</a>
                <a class="nav-link" href="{{ route('orders') }}"><span class="nav-icon">▤</span> Transactions
                    <b>28</b></a>
                @if (auth()->user()->role === 'admin')
                    <a class="nav-link" href="{{ route('inventory') }}"><span class="nav-icon">▦</span> Inventory
                        <b>3</b></a>
                    <a class="nav-link" href="{{ route('reports') }}"><span class="nav-icon">▥</span> Reports</a>
                    <a class="nav-link" href="{{ route('settings') }}"><span class="nav-icon">⚙</span> Settings</a>
                @endif
            </nav>
